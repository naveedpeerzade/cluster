...
class Cluster extends EventEmitter {
    ...
    display = null;
    duplicateCheckUrls = new Set();
    lastDomainAccesses = new Map();
    ...
    queueJob(data, taskFunction, callbacks) {
        ...
        const job = new Job(realData, realFunction, callbacks);
